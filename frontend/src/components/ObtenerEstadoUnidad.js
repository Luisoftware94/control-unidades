    ...
    render() {
        return (
            <div className="">
                ...
                { this.props.estado === 'Taller' ?  <div className="estado-unidad-principal yellow-fuerte" id={this.props.unidad}><h6>{this.props.estado}</h6></div>: null}
                { this.props.estado === 'Guardia' ?  <div className="estado-unidad-principal azul" id={this.props.unidad}><h6>{this.props.estado}</h6></div>: null}
                ...
                { this.props.estado === 'Inactivo' ?  <div className="estado-unidad-principal gray" id={this.props.unidad}><h6>{this.props.estado}</h6></div>: null}
